...
public class PhoenixDatabaseMetaData implements DatabaseMetaData {
    ...
    public static final String SYSTEM_STATS_NAME = SchemaUtil.getTableName(SYSTEM_CATALOG_SCHEMA, SYSTEM_STATS_TABLE).replace(':', '.');
    ...
    public static final String SYSTEM_TASK_NAME = SchemaUtil.getTableName(SYSTEM_CATALOG_SCHEMA, SYSTEM_TASK_TABLE).replace(':', '.');
